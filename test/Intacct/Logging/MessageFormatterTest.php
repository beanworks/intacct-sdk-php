...
namespace BWIntacct\Logging;

use GuzzleHttp\Psr7\Request;
use GuzzleHttp\Psr7\Response;
use BWIntacct\Content;
use BWIntacct\Functions\ApiSessionCreate;
use BWIntacct\Xml\RequestBlock;

/**
 * @coversDefaultClass \BWIntacct\Logging\MessageFormatter
 */
