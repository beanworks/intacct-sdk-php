...
namespace BWIntacct\Xml\Response\Operation;

use BWIntacct\Xml\SynchronousResponse;
use Exception;

/**
 * @coversDefaultClass \BWIntacct\Xml\Response\Operation\Result
 */
...
EOF;
    ...
    /**
     * @expectedException \BWIntacct\Exception\ResultException
