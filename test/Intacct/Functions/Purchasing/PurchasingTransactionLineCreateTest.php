...
namespace BWIntacct\Functions\Purchasing;

use BWIntacct\Functions\InventoryControl\TransactionItemDetail;
use BWIntacct\Xml\XMLWriter;

/**
 * @coversDefaultClass \BWIntacct\Functions\Purchasing\PurchasingTransactionLineCreate
 */
